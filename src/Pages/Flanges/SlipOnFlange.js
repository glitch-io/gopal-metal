        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              <h1>SLIP ON FLANGES</h1>
              <p>
                Slip-on Flanges have bored with a diameter slightly larger than
                the pipe; this helps it to slide\slip over the pipe. This ANSI
                B16.5 SORF Flange is then welded inside and outside too, with
                fillet welding. Alloy Steel Slip On Plate Flanges are thinner
                compared to other ranges, cost-effective and are easy to use in
                fabricated applications. We supply Carbon Steel Slip-on Raised
                Face Flanges in both raised face and at faced designs, to
                industries like agricultural, fertilizers, pharmaceutical,
                textile and for general engineering purposes
              </p>
            </div>
            <div className={styles.img}>
              <img
                src={process.env.PUBLIC_URL + "/Imgs/Product/Flange/slip.jpg"}
                alt="slip"
              />
            </div>
          </div>
          <h2>Standard Specication For Slip On Flanges</h2>
          <p>
