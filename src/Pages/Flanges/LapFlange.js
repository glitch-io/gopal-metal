        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              <h1>LAP FLANGES</h1>
              <p>
                Lap Flanges are used with a stub end, which is welded to the
                pipe. Alloy Steel Lapped Flanges are designed in a way that they
                swing over the pipe without the need to be welded. As they do
                not come in contact with the inner fluid, they do not corrode
                and can be re-used. Our ANSI B16.5 Stainless Steel Flanges are
                inexpensive and widely useful. In addition, they can be easily
                assembled and dismantled for a quick inspection
              </p>
            </div>
            <div className={styles.img}>
              <img
                src={process.env.PUBLIC_URL + "/Imgs/Product/Flange/lap.jpg"}
                alt="weld"
              />
            </div>
          </div>
          <h2>Standard Specification For Lap Joint Flanges</h2>
          <p>
