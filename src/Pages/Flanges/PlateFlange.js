        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              <h1>PLATE FLANGES</h1>
              <p>
                We are a manufacturer, supplier and exporter of Plate Flanges,
                which are accepted by major industries as a cost-efficient
                alternative to other types of flanges whose cost increases due
                to its expensive production pattern. Manufactured with
                procedures that are compliant with global flange standards, our
                Stainless Steel Plate Flanges are free from any cracks and
                deformities, due to which they last longer and provide an
                extended service lifespan. Our Carbon Steel Plate special
                maintenance needs,and added advantage to use them. We supply
                these ANSI B16.5 Plate Flanges to the irrigation industry.
              </p>
            </div>
            <div className={styles.img}>
              <img
                src={process.env.PUBLIC_URL + "/Imgs/Product/Flange/plate.jpg"}
                alt="plate"
              />
            </div>
          </div>
          <h2>Standard Specification For Plate Flanges</h2>
          <p>
            ...
            <br />
            <br />
            <strong>Duplex & Super Duplex Steel Weld Neck Flanges :</strong>ASTM
            ...
            F46, F52, F60, F65, F706 Low Temperature Carbon Steel Socket weld
            Flanges : ASTM A350, LF2, LF3
            <br />
            <br />
            <strong>Alloy Steel Weld Neck Flanges :</strong>ASTM / ASME A/SA 182
            & A 387 F1, F5, F9, F11, F12, F22, F91 Copper Alloy Steel Lap Joint
            Flanges : ASTM SB 61 , SB62 , SB151 , SB152 UNS No. C 70600 (Cu-Ni
            90/10), C 71500 (Cu-Ni 70/30), UNS No. C 10100, 10200, 10300, 10800,
            12000, 12200
            <br />
            <br />
            ...
            No. N06601), Hastelloy C 276 (UNS No. N10276)
            <br />
            <br />
