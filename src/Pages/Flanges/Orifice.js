      ...
      <div className={styles.flangeSec}>
        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              ...
              <p>
                ...
                measuring the flow rate of either liquids or gases in the
                respective pipeline. Pairs of pressure "Tappings", mostly on 2
                sides, directly opposite each other, are machined into the
                orifice flange. This makes separate orifice carriers or tappings
                in the pipe wall unnecessary. Orifice Flanges generally come
                with either Raised Faces or RTJ (Ring Type Joint) facings. They
                are, for all intensive purposes, the same as weld neck and slip
                on flanges with extra machining. The image on the right shows a
                set Orifice Flanges, where a Orifice Plate is mounted and a jack
                screw is machined. This jack screw is used to facilitate
            ...
            <div className={styles.img}>
              <img
                src={
                  process.env.PUBLIC_URL + "/Imgs/Product/Flange/orifice.jpg"
                }
                alt="orifice"
              />
            </div>
          ...
          <p>
            ...
            <br />
            <strong>Material & Grades of Orifice Flanges :</strong>
            <br /> <br />
            <strong> Stainless Steel Orifice Flanges : :</strong>ASTM A 182, A
            240 F 304, 304L, 304H, 316, 316L, 316Ti, 310, 310S, 321, 321H, 317,
            347, 347H, 904L
            <br />
            <br />
            <strong>Duplex & Super Duplex Steel Orifice Flanges :</strong> ASTM
            / ASME A/SA 182 F 44, F 45, F51, F 53, F 55, F 60, F 61
            <br />
            <br />
            <strong> Carbon Steel Orifice Flanges :</strong> ASTM / ASME A/SA
            105 ASTM / ASME A 350 , ASTM A 181 LF 2 / A516 Gr.70 A36, A694 F42,
            F46, F52, F60, F65, F706
            <br />
            <br />
            Low Temperature Carbon Steel Orifice Flanges : ASTM A350, LF2, LF3{" "}
            <br />
            <br />
            <strong>Alloy Steel Orifice Flanges :</strong> ASTM / ASME A/SA 182
            & A 387 F1, F5, F9, F11, F12, F22, F91 <br />
            <br />
            Copper Alloy Steel Orifice Flanges : ASTM SB 61 , SB62 , SB151 ,
            SB152 UNS No. C 70600 (Cu-Ni 90/10), C 71500 (Cu-Ni 70/30), UNS No.
            C 10100, 10200, 10300, 10800, 12000, 12200
            <br />
            <br />
            <strong>Nickel Alloy Orifice Flanges :</strong>ASTM SB564, SB160,
