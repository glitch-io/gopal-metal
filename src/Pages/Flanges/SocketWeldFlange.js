...
function SocketWeldFlange() {
  return (
    <>
      <Banner title={"Socket Weld Flanges"} />
        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              ...
              <p>
                Socket Weld Flanges (SWRF) are counter-bored i.e. the bore of
                the Flange and pipe, both are same, thereby providing a good ow
                of the product through the pipe. Initially used for small-sized
                high-pressure pipes, our SMO 254 Socket Weld Flanges are now
                used in high-pressure systems too. Our Stainless Steel Socket
                Weld Flanges are oxidation resistant and promote better
                weldability and fabricability. We seek to offer ANSI B16.5
                Carbon Steel Socket Weld Flanges that have excellent stress
                corrosion cracking resistance to the LNG, seawater and mining
                industry.
              </p>
            </div>
            <div className={styles.img}>
              <img
                src={process.env.PUBLIC_URL + "/Imgs/Product/Flange/socket.jpg"}
                alt="socket"
              />
            </div>
          </div>
          <h2>Standard Specification For Socket Weld Flanges</h2>
          <p>
            ...
            & A 387 F1, F5, F9, F11, F12, F22, F91 Copper Alloy Steel Socket
            weld Flanges : ASTM SB 61 , SB62 , SB151 , SB152 UNS No. C 70600
