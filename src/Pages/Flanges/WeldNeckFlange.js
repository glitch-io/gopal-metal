        ...
        <div className={styles.contentFlange}>
          <div className={styles.flangeHead}>
            <div className={styles.flangeText}>
              ...
              <p>
                Weld Neck Flange is flanges that designed to be joined to a
                piping system by butt welding. This kind of flange include lots
                of specification. Weld Neck Flange is expensive because of its
                long neck and cost of people for contact WN flange with pipeline
                or fitting but is preferred for high-stress applications. The
                necks, or hubs, transmits stresses to the pipeline. The gradual
                transition of thickness from the base of the hub to the wall
                thickness at the butt weld provides important reinforcement of
                the Weld Neck Flange. The bore of Weld-Neck flange matches bore
                of the pipeline, reducing turbulence and erosion.
              </p>
            </div>
            <div className={styles.img}>
              <img
                src={process.env.PUBLIC_URL + "/Imgs/Product/Flange/weld.jpg"}
                alt="weld"
              />
            </div>
          </div>
          <h2>Standard Specification For Weld Neck Flanges</h2>
          <p>
            Weld Neck Flange is flanges that designed to be joined to a piping
            system by butt welding. This kind offlange include lots of
            specification, Weld neck Flange is expensive because of its long
            neck and cost of people for contact WN flange with pipeline or
            fitting but is preferred for high stress applications. The necks, or
            hubs, transmits stresses to the pipeline.
            <br />
            <br />
            The gradual transition of thickness from the base of the hub to the
            wall thickness at the butt weld provides important reinforcement of
            the Weld Neck flange. The bore of Weld-Neck flange matches bore of
            the pipeline, reducing turbulen.
            <br />
            <br />
            <strong>Dimensions :</strong> ANSI B16.5, ANSI B16.47 Series A & B,
            MSS SP44, ASA, API-605, AWWA, Custom Drawings Size : 1/2″ (15 NB) to
            48″ (1200NB)
            <br />
            ...
            <strong>JIS Standards :</strong> 2220-2004 5k/10k/16k , ETC <br />
            <strong>Flange Face Type :</strong> Flate Face (FF), Raised Face
            (RF), Ring Type Joint (RTJ) <br />
            <br />
            <strong>Material & Grades of Weld Neck Flanges (WNRF) :</strong>
            <br />
            <br />
            ...
            F46, F52, F60, F65, F706 Low Temperature Carbon Steel Weld Neck
            Flanges : ASTM A350, LF2, LF3 <br />
            <br />
            <strong>Alloy Steel Weld Neck Flanges :</strong> ASTM / ASME A/SA
            182 & A 387 F1, F5, F9, F11, F12, F22, F91 <br />
            <br />
            <strong>Copper Alloy Steel Weld Neck Flanges :</strong> ASTM SB 61 ,
            ...
            <br /> At Arihant Engineers Exports , all fittings and flanges are
            subject to strict inspection at each stage of the production
            process, from starting material purchasing to product dispatch. They
            are visually examined for conformity to ASTM, ASME, MSS, DIN, EN,
            and JIS codes and standards. Upon request, official certified
            Inspection Agencies can be called in to witness the material
            reports, dimensions and quality conformity of products. <br />
            <br />
